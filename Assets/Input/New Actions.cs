...
public partial class @NewActions: IInputActionCollection2, IDisposable
{
    ...
    ~@NewActions()
    {
        UnityEngine.Debug.Assert(!m_OnFoot.enabled, "This will cause a leak and performance issues, NewActions.OnFoot.Disable() has not been called.");
    }
    ...
    public struct OnFootActions
    {
        ...
        /// </summary>
        public OnFootActions(@NewActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
